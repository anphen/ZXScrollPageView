...
- (void)scrollToPoint:(CGPoint)point CompleteHandle:(void(^)())completeHandle animation:(BOOL)animation{
    if (animation) {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            [weakSelf.indicateView setMj_w:[self.itemWidthArray[self.currentIndex] floatValue]];
            [weakSelf.indicateView setMj_x:[self.itemOriginXArray[self.currentIndex]floatValue]];
